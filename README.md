...
> A curated collection of research papers focusing on adversarial attacks for **3D Point Cloud Classification** from **2019 to Present**. This repository systematically tracks the evolution of the field, ranging from early explorations to the latest State-of-the-Art (SOTA) studies presented at top-tier venues like CVPR, ICCV, AAAI, and TPAMI. It serves as a comprehensive guide to understanding the developmental trajectory of point cloud attacks and identifying key publication opportunities.
...
- **Access State-of-the-Art:** Stay updated with the latest SOTA works up to **Present**, helping researchers quickly identify current performance ceilings and open challenges.
...
- **[Transferable and undefendable point cloud attacks via medial axis transform](https://www.sciencedirect.com/science/article/pii/S0167839626000087)**  
  ![Venue](https://img.shields.io/badge/CAGD-2026-red) 
  ![CCF](https://img.shields.io/badge/CCF-B-green)
...
- **[CMFA: Cross-model feature alignment for transferable 3D adversarial attacks](https://www.sciencedirect.com/science/article/abs/pii/S0925231226012774)**  
  ...
  ![CCF](https://img.shields.io/badge/CCF-C-green)
  ![中科院分区](https://img.shields.io/badge/中科院分区-2_区%20-important)
  [![Code](https://img.shields.io/badge/Code-GitHub-black)](https://github.com/chenjun0326/CMFA)
